...
## Purpose
React component providing UI functionality. Contains 0 component(s) with 27 lines of JSX/TSX code.
...
- @/lib/utils
- "react"
- "@radix-ui/react-switch"  # Limited to top 10
...
- "react"
- react
- @radix-ui/react-switch  # Limited to top 15
...
- Monitor performance with 27 lines of code
