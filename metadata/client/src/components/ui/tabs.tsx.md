...
## Purpose
React component providing UI functionality. Contains 0 component(s) with 53 lines of JSX/TSX code.
...
- @/lib/utils
- "react"
- "@radix-ui/react-tabs"  # Limited to top 10
...
- Monitor performance with 53 lines of code
