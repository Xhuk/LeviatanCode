...
export class MemStorage implements IStorage {
  ...
  async createProject(insertProject: InsertProject): Promise<Project> {
    ...
    const project: Project = {
      ...
      documentation: (insertProject.documentation as ProjectDocumentation) ?? null,
      createdAt: new Date(),
      updatedAt: new Date()
    };
  ...
  async createProjectExecution(insertExecution: InsertProjectExecution): Promise<ProjectExecution> {
    ...
    const execution: ProjectExecution = {
      ...
      id,
      status: "pending",
      workingDirectory: insertExecution.workingDirectory ?? null,
      createdAt: new Date(),
      completedAt: null,
      output: null,
      error: null,
  ...
  async createDocumentation(insertDoc: InsertDocumentation): Promise<Documentation> {
    ...
    const doc: Documentation = {
      ...insertDoc,
      id,
      autoGenerated: insertDoc.autoGenerated ?? true,
  ...
  async createVaultSecret(insertSecret: InsertVaultSecret): Promise<VaultSecret> {
    ...
    const secret: VaultSecret = {
      ...insertSecret,
      id,
      description: insertSecret.description ?? null,
      category: insertSecret.category ?? null,
      createdAt: new Date(),
      updatedAt: new Date()
    };
